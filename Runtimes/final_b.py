...
df_lime=df_lime.sort_values(by='time')
...
plt.axvline(1, linestyle=':', color='black', linewidth=3)
...
plt.plot(df_lime['case_number'], df_lime['cumm_time'], label='LIME', marker='^', linewidth=1)
...
plt.xticks([1,7,19,40,60,80,100], labels=['$\mathbf{1}$', '$\mathbf{7}$', '$\mathbf{19}$', '40', '60', '80', '100'], fontsize=19)
...
plt.plot(df_lime['case_number'], df_lime['time'], label='LIME times', marker='^')
